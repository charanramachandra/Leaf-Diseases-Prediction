...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.radioButton_torch.setGeometry(QRect(470, 145, 95, 20))
        self.torchlabel = QLabel(self.frame) 
        self.torchlabel.setText("PyTorch")
        self.torchlabel.setGeometry(QRect(490, 145, 95, 20))
...
class Window2(QMainWindow):
    def __init__(self, parent=None):
        ...
        highlight_dir = 'C://Users//suhas//Downloads//leaf-diseases-predition-master//testimage'
